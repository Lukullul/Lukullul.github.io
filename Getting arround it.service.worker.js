...
/** @type {string} */
const CACHE_VERSION = '1753971573|8610716678';
/** @type {string} */
const CACHE_PREFIX = 'Getting arround -sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Getting arround it.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Getting arround it.html","Getting arround it.js","Getting arround it.offline.html","Getting arround it.icon.png","Getting arround it.apple-touch-icon.png","Getting arround it.audio.worklet.js","Getting arround it.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Getting arround it.wasm","Getting arround it.pck"];
